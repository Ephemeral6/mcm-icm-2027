...
> 本文件由官方 PDF 自动提取为纯文本，供全文检索与快速阅读；排版、图片、表格线条、公式符号可能丢失或错位，**格式与法律效力以同目录下的 [2021_MCM_Problem_C.pdf](2021_MCM_Problem_C.pdf) 原件为准**。
...
Reference
      1. Washington State Department of Agriculture. 2020 Asian Giant Hornet Public
